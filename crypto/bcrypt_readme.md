...
```bash
go test -v --bench github.com/shapeshift/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/shapeshift/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/shapeshift/cosmos-sdk/crypto/keys/mintkey	12.093s
```
